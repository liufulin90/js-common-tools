...
(function () {
  var JSCT = { arrayUnique: _array.arrayUnique, arrayQuickSort: _array.arrayQuickSort, isArray: _array.isArray, inArray: _array.inArray,
    ...
    Timer: _date.Timer, getNowTimeFormat: _date.getNowTimeFormat, timestampFormat: _date.timestampFormat, dateStr2timestamp: _date.dateStr2timestamp, getWeekByDate: _date.getWeekByDate, getWeekDaysByYearIndex: _date.getWeekDaysByYearIndex, getFurtureWeeksInfo: _date.getFurtureWeeksInfo,
